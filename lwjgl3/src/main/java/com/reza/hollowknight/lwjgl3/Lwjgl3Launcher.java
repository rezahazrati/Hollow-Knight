package com.reza.hollowknight.lwjgl3;
...
public class Lwjgl3Launcher {
    public static void main(String[] args) {
        ...
        Configuration.GLFW_CHECK_THREAD0.set(false);// This handles macOS support and helps on Windows.
        createApplication();
    }

    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new HollowGame(), getDefaultConfiguration());
    }
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        // 2. Force the window to launch maximized (fills the whole screen instantly)
        configuration.setMaximized(true);

        // 3. Set a fallback resolution in case the OS fails to maximize it
